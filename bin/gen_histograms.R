...
histogram(axon_area, data, xlab="Axon Area", nint = 30, xlim=c(-10,60), ylim=c(0,30))
dev.off()
...
histogram(fiber_area, data, xlab="Fiber Area", nint = 30, xlim=c(-10,200), ylim=c(0,40))
dev.off()
...
histogram(axon_diameter, data, xlab="Axon Diameter", nint = 30, xlim=c(-1,10), ylim=c(0,20))
dev.off()
...
histogram(fiber_diameter, data, xlab="Fiber Diameter", nint = 30, xlim=c(-1,15), ylim=c(0,25))
dev.off()
...
histogram(ratio_g, data, xlab="Ratio G", nint = 30, xlim=c(-.1,1), ylim=c(0,20))
dev.off()
